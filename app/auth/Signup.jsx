        ...
        <View style={{ width: '100%', marginTop: 'auto', height: '100%' }}>
          <View style={{
            ...
            <ScrollView>
              ...
              <CustomText placeholder='Fullname' icon='person' value={fullname} onChangeHandler={setFullname} />
              <CustomText placeholder='Email' icon='mail' value={email} onChangeHandler={setEmail} />
              <CustomText placeholder='Username' icon='person' value={username} onChangeHandler={setUsername} />
              <CustomText placeholder='Password' icon='key' value={password} isPass={true} onChangeHandler={setPassword} />
              <CustomText placeholder='Confirm Password' icon='key' value={confirmPassword} isPass={true} onChangeHandler={setConfirmPassword} />
